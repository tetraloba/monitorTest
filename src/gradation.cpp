...
int main(){
    // string fName = "gradation_red.svg"; // RED
    // string fName = "gradation_green.svg"; // GREEN
    string fName = "gradation_blue.svg"; // BLUE
    ...
    for (uint x = 0; x < 256; x++) {
        pos1.x = offset + x * r;
        // rect(pos1, Pos{pos1.x + r, pos1.y + 1080}, RGB{x, 0, 0}, fout); // RED
        // rect(pos1, Pos{pos1.x + r, pos1.y + 1080}, RGB{0, x, 0}, fout); // GREEN
        rect(pos1, Pos{pos1.x + r, pos1.y + 1080}, RGB{0, 0, x}, fout); // BLUE
    }
    pos1.x = offset + 256 * r;
